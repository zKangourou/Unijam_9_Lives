...
{
    public enum Bruitages {CHUTE,VOITURE,PROCHEPRISE,PRISE,NOYADE,LAZER,HACHOIR,BOSS_DEMONIAQUE, VIOLON, STOP};
    ...
    [SerializeField] AudioClip bruitageBoss;
    [SerializeField] AudioClip bruitageViolon;
    ...
    void InstancePlayBruitage(Bruitages name)
    {
        ...
        switch (name)
        {
            case Bruitages.STOP:
                originalClip = null;
                break;
            case Bruitages.VIOLON:
                originalClip = bruitageViolon;
                break;
            case Bruitages.BOSS_DEMONIAQUE:
                originalClip = bruitageBoss;
                break;
            case Bruitages.LAZER:
                originalClip = bruitageLazer;
                break;
